 ...
 * <LI>default.
 * </NL>
 * Multiple path specifications can be mapped by providing a list of specifications. By default this class uses characters ":," as path separators, unless configured differently by calling the static
...
public class PathMap<O> extends HashMap<String, O> {
     ...
     * 
     */
    private static final long serialVersionUID = 5441101813173226778L;
    /* ------------------------------------------------------------ */
    private static String __pathSpecSeparators = ":,";

    /* ------------------------------------------------------------ */
    /**
     * Set the path spec separator. Multiple path specification may be included in a single string if they are separated by the characters set in this string. By default this class uses ":,"
